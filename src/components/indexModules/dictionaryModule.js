...
const DictionaryModule = () => (
    <Card className="my-1">
        <Card.Body>
            ...
            <Button href="https://www.signbsl.com/"><img className="align-self-center" alt="Sign BSL Logo" src="https://www.signbsl.com/logo.svg" style={{ height: "1.5em" }} /> SignBSL</Button>{' '}
